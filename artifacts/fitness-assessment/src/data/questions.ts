    ...
    rules: [
      {
        ...
        rule: "Be asleep by 10:00 PM",
        execution: ["Go to bed on time", "Keep lights low before sleep"],
        why: "Most deep recovery happens early in the night. If you sleep late — you miss it.",
      },
      {
        number: "02",
        title: "SCREEN CUT-OFF RULE",
        rule: "No phone 30 mins before sleep",
        execution: ["Keep phone away from bed", "Avoid reels / scrolling"],
        why: "Screen light keeps your brain active — delays recovery and reduces sleep quality.",
      },
      {
        number: "03",
        title: "CAFFEINE CUT-OFF RULE",
        rule: "No caffeine after 2 PM",
        execution: ["Avoid tea / coffee in evening", "Switch to water or light drinks"],
        why: "Caffeine stays in your body for hours — reduces sleep quality without you realising it.",
      },
      {
        number: "04",
        title: "MORNING RECOVERY SIGNAL",
        rule: "First 20 minutes: No phone. Get sunlight. Move.",
        execution: ["Step outside / balcony", "Walk or stand in sunlight", "No scrolling"],
        why: "Recovery is not just about how you sleep — it's set by how you start your day.",
      },
    ],
  },
  nutrition: {
